...
const SinfCard:React.FC<{item: string; sinf_raqam: number}> = ({item, sinf_raqam}) => {
  return (
    <Link to={'/'}>
    <main className="max-w-6xl gap-2 w-80 max-h-48 h-40 flex items-center justify-center bg-white rounded-xl text-3xl shadow-lg hover:text-4xl hover:shadow-blue-300 ">
